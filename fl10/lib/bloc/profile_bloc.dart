...
import 'package:form_app/bloc/profile_event.dart';
    ...
    if (event is FetchProfileData) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          final Map<String, dynamic> jsonResponse = response.data; // Используйте response.data вместо json.decode(response.body)
